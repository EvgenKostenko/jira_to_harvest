...
class Harvest(object):
    def __init__(self, uri, email=None, password=None, client_id=None, token=None, token_updater=None, put_auth_in_header=True):
        ...
        if email and password:
            ...
            if put_auth_in_header:
                self.__headers['Authorization'] = 'Basic {0}'.format(enc64(('{self.email}:{self.password}'.format(self=self)).encode('utf-8')))
        elif client_id and token and token_updater:
            self.__auth         = 'OAuth2'
